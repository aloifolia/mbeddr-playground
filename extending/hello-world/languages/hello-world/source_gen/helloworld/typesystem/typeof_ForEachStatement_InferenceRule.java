...
public class typeof_ForEachStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode fes, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:4934c599-dc0b-40c9-8298-f020ee0a4a20(helloworld.typesystem)", "2483084443615272239", true), (SNode) _quotation_createNode_tq8cec_a0a0b(), false, true, _info_12389875345);
    }
    if (typeCheckingContext.typeOf(SLinkOperations.getTarget(fes, "array", true), "r:4934c599-dc0b-40c9-8298-f020ee0a4a20(helloworld.typesystem)", "2483084443615388779", true) == _quotation_createNode_tq8cec_a0b0b()) {
      {
  ...
  private static SNode _quotation_createNode_tq8cec_a0a0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.lang.core.structure.BaseConcept", null, null, GlobalScope.getInstance(), false);
    return quotedNode_1;
  }

  private static SNode _quotation_createNode_tq8cec_a0b0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
